    ...
    <div className="min-h-screen bg-white text-black">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-semibold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
            About Us
          </h1>
          <p className="text-xl md:text-2xl text-gray-600" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-16">
          {/* Mission */}
          <div className="flex flex-col items-center p-8 bg-gray-300 text-black rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
        ...
        {/* Team Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold mb-6 text-center" style={{ fontFamily: "'Playfair Display', serif" }}>
            Meet the Team
          </h2>
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-xl mx-auto">
            <p className="italic text-gray-600">"The Library Management System has transformed how we manage our collections. It's intuitive, efficient, and makes book tracking a breeze!"</p>
            <p className="font-semibold mt-2">– Jane Doe, Library Manager</p>
          </div>
        </div>

        {/* FAQ Section */}
        <div className="bg-gray-100 py-12 px-6 rounded-xl max-w-3xl mx-auto">
          <h2 className="text-3xl font-semibold mb-6 text-center">Frequently Asked Questions</h2>
          <div className="space-y-6">
            <div className="p-4 bg-gray-300 shadow rounded-lg">
              <h3 className="font-medium text-lg">How do I borrow books from the library?</h3>
              <p className="text-gray-600 mt-2">Simply log in, search for a book, and click "Borrow" to check it out.</p>
            </div>
            <div className="p-4 bg-gray-300 shadow rounded-lg">
              <h3 className="font-medium text-lg">Can I reserve a book online?</h3>
              <p className="text-gray-600 mt-2">Yes, our system allows you to reserve books online and get notified once they are available.</p>
            </div>
            <div className="p-4 bg-gray-300 shadow rounded-lg">
              <h3 className="font-medium text-lg">How do I return a borrowed book?</h3>
              <p className="text-gray-600 mt-2">You can return books by visiting the library and scanning the book's barcode at the return station.</p>
            </div>
          </div>
        </div>
      </div>
